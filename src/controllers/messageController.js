  ...
  async handleSymptomCheck(user, message, currentState, mediaData = null) {
    try {
      if (currentState !== 'symptom_check') {
        // First time - show symptom checker intro
        const promptTexts = {
          en: '🩺 *Symptom Checker*\n\nPlease tell me your symptoms (e.g., fever, cough, headache).\n\n⚠️ *Emergency Warning:*\nIf you have severe chest pain, heavy bleeding, or trouble breathing, CALL 108 immediately.\n\nType your symptoms below:',
          hi: '🩺 *लक्षण जांचकर्ता*\n\nकृपया मुझे अपने लक्षण बताएं (जैसे बुखार, खांसी, सिरदर्द)।\n\n⚠️ *आपातकालीन चेतावनी:*\nयदि आपको गंभीर छाती में दर्द, भारी रक्तस्राव, या सांस लेने में परेशानी है, तुरंत 108 पर कॉल करें।\n\nनीचे अपने लक्षण लिखें:',
          te: '🩺 *లక్షణ తనిఖీదారు*\n\nదయచేసి మీ లక్షణాలను చెప్పండి (ఉదా. జ్వరం, దగ్గు, తలనొప్పి)।\n\n⚠️ *అత్యవసర హెచ్చరిక:*\nమీకు తీవ్రమైన ఛాతీ నొప్పి, భారీ రక్తస్రావం లేదా శ్వాస తీసుకోవడంలో ఇబ్బంది ఉంటే, వెంటనే 108కు కాల్ చేయండి।\n\nమీ లక్షణాలను క్రింద టైప్ చేయండి:',
          ta: '🩺 *அறிகுறி சரிபார்ப்பாளர்*\n\nதயவுசெய்து உங்கள் அறிகுறிகளைச் சொல்லுங்கள் (எ.கா. காய்ச்சல், இருமல், தலைவலி)।\n\n⚠️ *அவசர எச்சரிக்கை:*\nஉங்களுக்கு கடுமையான மார்பு வலி, அதிக இரத்தப்போக்கு அல்லது மூச்சுத் திணறல் இருந்தால், உடனே 108ஐ அழைக்கவும்।\n\nஉங்கள் அறிகுறிகளை கீழே தட்டச்சு செய்யுங்கள்:',
          or: '🩺 *ଲକ୍ଷଣ ଯାଞ୍ଚକାରୀ*\n\nଦୟାକରି ମୋତେ ଆପଣଙ୍କ ଲକ୍ଷଣ କୁହନ୍ତୁ (ଯେମିତି ଜ୍ୱର, କାଶ, ମୁଣ୍ଡବିନ୍ଧା)।\n\n⚠️ *ଜରୁରୀକାଳୀନ ଚେତାବନୀ:*\nଯଦି ଆପଣଙ୍କର ଗୁରୁତର ଛାତି ଯନ୍ତ୍ରଣା, ଅଧିକ ରକ୍ତସ୍ରାବ, କିମ୍ବା ନିଶ୍ୱାସ ନେବାରେ କଷ୍ଟ ହେଉଛି, ତୁରନ୍ତ 108କୁ କଲ କରନ୍ତୁ।\n\nତଳେ ଆପଣଙ୍କ ଲକ୍ଷଣ ଟାଇପ କରନ୍ତୁ:'
        };
...
निर्देश:
1. उनके द्वारा टाइप किए गए लक्षणों को दोहराएं।
2. यदि अस्पष्ट है, तो स्पष्टीकरण प्रश्न पूछें (अवधि, गंभीरता, ट्रिगर, अतिरिक्त लक्षण)।
3. संभावित सामान्य कारण सुझाएं (कोई सटीक निदान नहीं)।
4. स्व-देखभाल और रोकथाम प्रदान करें (तरल पदार्थ, आराम, स्वच्छता, ORS)।
5. डॉक्टर से कब मिलना है इसके लिए रेड फ्लैग सूचीबद्ध करें।
6. हमेशा शामिल करें: "⚠️ यह निदान नहीं है। यदि लक्षण बने रहते हैं या बिगड़ते हैं तो कृपया डॉक्टर से मिलें।"
7. कभी भी दवा या खुराक का सुझाव न दें।
8. यदि उपयोगकर्ता गैर-लक्षण प्रश्न पूछता है, तो कहें: "कृपया इसके लिए AI से बात करें का उपयोग करें।"
...
సూచనలు:
1. వారు టైప్ చేసిన లక్షణాలను పునరావృతం చేయండి.
2. అస్పష్టంగా ఉంటే, స్పష్టీకరణ ప్రశ్నలు అడగండి (వ్యవధి, తీవ్రత, ట్రిగ్గర్లు, అదనపు లక్షణాలు).
3. సాధ్యమైన సాధారణ కారణాలను సూచించండి (ఖచ్చితమైన నిర్ధారణ లేదు).
4. స్వీయ-సంరక్షణ మరియు నివారణ అందించండి (ద్రవాలు, విశ్రాంతి, పరిశుభ్రత, ORS).
5. వైద్యుడిని ఎప్పుడు చూడాలో రెడ్ ఫ్లాగ్‌లను జాబితా చేయండి.
6. ఎల్లప్పుడూ చేర్చండి: "⚠️ ఇది నిర్ధారణ కాదు. లక్షణాలు కొనసాగితే లేదా దిగజారితే దయచేసి వైద్యుడిని సంప్రదించండి."
7. ఎప్పుడూ మందు లేదా మోతాదును సూచించవద్దు.
8. వినియోగదారు లక్షణేతర ప్రశ్నలు అడిగితే, చెప్పండి: "దయచేసి దాని కోసం AI తో చాట్ ఉపయోగించండి."
