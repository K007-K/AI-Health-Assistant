...
class SchedulerService {
  ...
  // Schedule test alert for 4:00 PM TODAY (for testing purposes)
  scheduleTestAlert() {
    cron.schedule('0 16 * * *', async () => {
      console.log('🧪 TEST ALERT: Starting outbreak broadcast at 4:00 PM IST');
      ...
      try {
        ...
        if (nationalAlert) {
          ...
          console.log('✅ TEST ALERT: Outbreak broadcast completed successfully at 4:00 PM');
        } else {
          console.log('ℹ️ TEST ALERT: No national outbreak alert to broadcast at 4:00 PM');
          ...
          if (testAlert) {
            ...
            console.log('✅ TEST ALERT: Demo alert broadcast completed at 4:00 PM');
          }
        }
    ...
    console.log('🧪 TEST ALERT: Outbreak broadcast scheduled for 4:00 PM IST TODAY');
  }
  ...
  getStatus() {
    ...
    return {
      ...
      jobs: {
        ...
        testAlert: {
          schedule: '0 16 * * *',
          description: 'TEST ALERT: Outbreak broadcast at 4:00 PM IST TODAY',
