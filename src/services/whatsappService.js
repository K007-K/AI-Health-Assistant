      ...
      en: {
        sections: [{
          ...
          rows: [
            ...
            { id: 'preventive_tips', title: '🌱 Preventive Healthcare Tips', description: 'Learn about diseases, nutrition & lifestyle' },
      ...
      te: {
        sections: [{
          ...
          rows: [
            ...
            { id: 'preventive_tips', title: '🌱 నివారణ ఆరోగ్య చిట్కాలు', description: 'వ్యాధులు, పోషణ & జీవనశైలి గురించి తెలుసుకోండి' },
      ...
      ta: {
        sections: [{
          ...
          rows: [
            ...
            { id: 'preventive_tips', title: '🌱 தடுப்பு சுகாதார குறிப்புகள்', description: 'நோய்கள், ஊட்டச்சத்து & வாழ்க்கை முறை பற்றி அறியுங்கள்' },
      ...
      or: {
        sections: [{
          ...
          rows: [
            ...
            { id: 'preventive_tips', title: '🌱 ପ୍ରତିରୋଧକ ସ୍ୱାସ୍ଥ୍ୟ ଟିପ୍ସ', description: 'ରୋଗ, ପୋଷଣ ଏବଂ ଜୀବନଶୈଳୀ ବି�ୟଷୟରେ ଜାଣନ୍ତୁ' },
