...
1️⃣ Chat with AI
2️⃣ My Appointments & Schedule (Coming Soon)
3️⃣ Preventive Healthcare Tips
4️⃣ Check Symptoms
5️⃣ Real-time Outbreak Alerts (Coming Soon)
6️⃣ Feedback & Accuracy Improvement

Choose an option.`,
    hi: `📋 मुख्य मेनू — कृपया एक विकल्प चुनें:

1️⃣ AI से बात करें
2️⃣ मेरी अपॉइंटमेंट्स (जल्द आ रहा है)
3️⃣ स्वास्थ्य सुझाव
4️⃣ लक्षण जांचें
5️⃣ बीमारी अलर्ट (जल्द आ रहा है)
6️⃣ फीडबैक
...
2️⃣ నా అపాయింట్‌మెంట్‌లు (త్వరలో వస్తుంది)
3️⃣ నివారణ ఆరోగ్య చిట్కాలు
4️⃣ లక్షణాలు తనిఖీ చేయండి
5️⃣ వ్యాధి అలర్ట్‌లు (త్వరలో వస్తుంది)
6️⃣ ఫీడ్‌బ్యాక్
